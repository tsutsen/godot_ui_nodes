Some extra functionality for Godot's Control nodes. Now, this addon includes modifiers to make Control nodes resizeable or draggable in-game. More modifiers are planned for the future.
